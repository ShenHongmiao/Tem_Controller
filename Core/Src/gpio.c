...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(Control_1_GPIO_Port, Control_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : Control_1_Pin */
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(EXTI3_IRQn, 6, 0);  // 降低优先级，减少对实时任务的影响
